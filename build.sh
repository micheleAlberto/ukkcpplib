...
echo "compile app"
rm bin/app
g++ -std=gnu++11 src/tree/node.o  src/tree/tree.o src/tree/dot.o src/utils/utils.o src/app/app.cpp -o bin/app
echo "compile buildTree"
rm bin/buildTree
g++ -std=gnu++11 src/tree/node.o  src/tree/tree.o src/tree/dot.o src/utils/utils.o src/app/buildTree.cpp -o bin/buildTree
echo "compile python module"
rm bin/_tree.so
rm bin/tree.py
g++ -shared -fPIC src/tree/node.o  src/tree/tree.o src/tree/dot.o src/utils/utils.o src/python/python_wrapper.o -o bin/_tree.so -std=gnu++11 -I/usr/include/python2.7 -I/usr/include/x86_64-linux-gnu/python2.7  -fno-strict-aliasing -D_FORTIFY_SOURCE=2 -g -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security  -DNDEBUG -g -fwrapv -O2 -Wall
